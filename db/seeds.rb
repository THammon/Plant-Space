...
sp1 = Species.create(category_name: "Flower", frequency_watered: 8, care: "Need Water and Vitamens")
sp2 = Species.create(category_name: "Tree", frequency_watered: 4, care: "Water every 3 days")
sp3 = Species.create(category_name: "Pansy", frequency_watered: 9, care: "Constant Water, Check Soil Concentration")
